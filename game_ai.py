                    ...
                    if (
                        ...
                        if mousesquare[0] < 4:
                            ...
                            if gameboard.num_pieces() >= 12:
                                threading.Thread(
                                    target=eval.play_best_move, args=[2]
                                ).start()
                            elif gameboard.num_pieces() >= 8:
                                threading.Thread(
                                    target=eval.play_best_move, args=[3]
                                ).start()
                            elif gameboard.num_pieces() >= 4:
                                threading.Thread(
                                    target=eval.play_best_move, args=[4]
                                ).start()
                            else:
                                threading.Thread(
                                    target=eval.play_best_move, args=[5]
                                ).start()
                            cont = True
                            continue
            if cont:
